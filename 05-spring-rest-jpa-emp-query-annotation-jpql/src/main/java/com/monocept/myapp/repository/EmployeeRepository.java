...
//	@Query("select e from Employee e where e.designation=?1 and e.salary>?2")
	@Query("select e from Employee e where e.designation=:designation and e.salary>:salary")
	public Page<Employee> getBySalaryAndDesignation(String designation,double salary, Pageable pageable);
